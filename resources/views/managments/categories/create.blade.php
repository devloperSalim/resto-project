        ...
        <section class="w-3/4 p-8">
            ...
            <header class="bg-white p-4 flex justify-between items-center shadow-md">
                <h2 class="text-2xl font-bold flex items-center">
                    <i class="fas fa-th-large mr-2"></i> Ajouter category
                </h2>
            ...
            <!-- Form -->
            <div class="mt-8">
                <form action="{{ route('categories.store') }}" method="POST" class="max-w-md mx-auto bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                    @csrf
                    <div class="mb-4">
